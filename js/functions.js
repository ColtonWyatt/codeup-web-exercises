...
var billTotal = (Number(prompt("How much was your bill total? ")))
    console.log("What is your total bill due? " + billTotal)
var tipPercent = (Number(prompt("What percent would you like to tip? ")))
    console.log("What percent would you like to tip? " + tipPercent)
var totalTip = billTotal * tipPercent


calculateTip("billTotal", "billPercent")
